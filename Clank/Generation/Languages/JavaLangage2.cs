    ...
    public class JavaGenerator : ILanguageGenerator
    {
        ...
        public string GenerateConstructor(ClassDeclaration decl)
        {
            ...
            foreach (var vdecl in varDecls)
            {
                ...
                else if (d.Var.Type.BaseType.JType == JSONType.Int)
                    if (!d.Var.Type.BaseType.IsEnum)
                        b.AppendLine("\t" + d.Var.Name + " = 0;");
                    else
                    {
                        b.AppendLine("\t" + d.Var.Name + " = " + GenerateTypeInstanceName(d.Var.Type) + "." + d.Var.Type.BaseType.EnumValues.First().Key + ";");
                    }
                else if (d.Var.Type.BaseType.JType == JSONType.Float)
                    b.AppendLine("\t" + d.Var.Name + " = 0.0f;");
                else if (d.Var.Type.BaseType.JType == JSONType.Bool)
                    b.AppendLine("\t" + d.Var.Name + " = true;");
                else if (d.Var.Type.BaseType.JType == JSONType.String)
                    b.AppendLine("\t" + d.Var.Name + " = \"\";");
            }
        ...
        string GenerateOperator(Operator op)
        {
            switch(op)
            {
                ...
                case Operator.Inf: return "<";
                case Operator.Sup: return ">";
                case Operator.InfEq: return "<=";
                case Operator.SupEq: return ">=";
            }
