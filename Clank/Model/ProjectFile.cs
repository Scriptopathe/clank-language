...
namespace Clank.Core.Model
{
    ...
    public class ProjectFile
    {
        ...
        public List<Language.Instruction> GenerateServerProject()
        {
            ...
            {
                // Ne garde que les fonctions.
                return inst is Language.FunctionDeclaration | inst is Language.VariableDeclarationInstruction | inst is Language.VariableDeclarationAndAssignmentInstruction;
            }).ToList();
