...
namespace Clank.Core.Tokenizers
{
    ...
    public class Tokenizer
    {
        ...
        public static List<Token> Parse(string script, Dictionary<int, Generation.Preprocessor.Preprocessor.LineInfo> lineMappings)
        {
            ...
            while(!lex.IsOEF())
            {
                ...
                else
                {
                    ...
                    // Opérateur
                    #region Operator
                    else if (isOperatorChar(chr, lookup, currentWord, isParsingOperator))
                    {
        ...
        /// </summary>
        static bool isOperatorChar(char chr, char lookup, List<char> previousChrs, bool isParsingOperator)
        {
