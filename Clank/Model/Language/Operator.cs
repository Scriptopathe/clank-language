...
namespace Clank.Core.Model.Language
{
    ...
    public class Operators
    {
        ...
        public static Dictionary<Operator, Dictionary<string, Dictionary<string, string>>> OperatorTypingMapping = new Dictionary<Operator, Dictionary<string, Dictionary<string, string>>>()
        {
            ...
            {Operator.Sup, new Dictionary<string, Dictionary<string, string>>()
                {
                    {"int", new Dictionary<string, string>()
                        {
                            {"int", "bool"}
            ...
            {Operator.SupEq, new Dictionary<string, Dictionary<string, string>>()
                {
                    {"int", new Dictionary<string, string>()
                        {
                            {"int", "bool"}
            ...
            {Operator.Inf, new Dictionary<string, Dictionary<string, string>>()
                {
                    {"int", new Dictionary<string, string>()
                        {
                            {"int", "bool"}
            ...
            {Operator.InfEq, new Dictionary<string, Dictionary<string, string>>()
                {
                    {"int", new Dictionary<string, string>()
                        {
                            {"int", "bool"}
        ...
        public static Operator ParseOperator(Tokenizers.ExpressionToken token)
        {
            ...
            switch(token.Content)
            {
                ...
                case "<":
                    return Operator.Inf;
                case "<=":
                    return Operator.InfEq;
                case ">":
                    return Operator.Sup;
                case ">=":
                    return Operator.SupEq;
                case ".":
                    return Operator.Dot;
                case "==":
